...
export default function Hero() {
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 pt-24 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-semibold tracking-tight text-slate-800 leading-[1.1]">
            ...
            <p className="text-base sm:text-lg lg:text-2xl text-slate-400 leading-relaxed max-w-xl font-light">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link href="/signup">
                <motion.button
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 sm:px-10 py-3 sm:py-4 bg-slate-800 text-white rounded-2xl font-medium shadow-xl shadow-slate-200 hover:shadow-2xl transition-all flex items-center gap-2 group text-base sm:text-lg w-full sm:w-auto justify-center"
                >
                  Get Started
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="col-span-1 sm:col-span-2 bg-white/40 backdrop-blur-sm p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] border border-slate-100 shadow-sm transition-all hover:bg-white/60">
              ...
              <div className="bg-white/40 backdrop-blur-sm p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] border border-slate-100 shadow-sm hover:border-indigo-100 transition-all">
              ...
              <div className="bg-white/40 backdrop-blur-sm p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] border border-slate-100 shadow-sm hover:border-blue-100 transition-all">
