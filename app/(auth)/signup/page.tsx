    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 py-24 sm:py-12 overflow-x-hidden overflow-y-auto bg-slate-950">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2 font-medium">Create an account to start your journey.</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-[2.5rem] shadow-2xl shadow-black/50 overflow-hidden relative group">
          ...
          <form action={action} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                disabled={isPending}
                className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-2xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-medium"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-4 bg-linear-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-black text-lg shadow-xl shadow-indigo-600/20 hover:shadow-indigo-600/40 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:hover:scale-100 mt-2"
            >
              {isPending ? (
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-slate-400 font-medium text-sm">
              ...
              <Link href="/login" className="text-white font-black hover:text-indigo-400 transition-colors hover:underline underline-offset-4 decoration-2">
                Log in
              </Link>
            </p>
          </div>
        ...
        {/* Footer Info */}
        <p className="text-center mt-8 text-slate-500 text-[10px] font-bold tracking-[0.2em] uppercase px-4 leading-relaxed">
